module github.com/Rohanrevanth/chat-demo-go/http

go 1.23.1

require (
	github.com/Rohanrevanth/chat-demo-go/routes v0.0.0-00010101000000-000000000000
...
replace github.com/Rohanrevanth/chat-demo-go-test/routes => ../routes
