module github.com/Rohanrevanth/chat-demo-go/routes
...
require (
	github.com/Rohanrevanth/chat-demo-go/auth v0.0.0-00010101000000-000000000000
	github.com/Rohanrevanth/chat-demo-go/controllers v0.0.0-00010101000000-000000000000
	github.com/Rohanrevanth/chat-demo-go/websockets v0.0.0-00010101000000-000000000000
	github.com/gin-gonic/gin v1.10.0
)

require (
	github.com/Rohanrevanth/chat-demo-go/database v0.0.0-00010101000000-000000000000 // indirect
